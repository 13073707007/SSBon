 ...
 */
package com.loongme.activity.widgets.gestureimg;
...
public class GestureImageViewTouchListener implements OnTouchListener {
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		// TODO 判断是否处于缩放状态 如果处于缩放状态 则禁止父控件滑动
		if (isZoomed() && (image.getDrawable().getIntrinsicHeight() * currentScale) > v.getHeight())
	...
	protected void handleUp() {
		...
		/**
		 * TODO recalculate zoomed after lastScale changed.
		 */
