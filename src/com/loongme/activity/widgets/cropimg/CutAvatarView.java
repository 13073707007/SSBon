...
public class CutAvatarView extends ImageView {
	...
	public Bitmap clip(boolean isCircle) {
		...
		RectF dst = new RectF(-bitmap.getWidth() / 2 + mCircleRadius, -getHeight() / 2 + mCircleRadius,
				bitmap.getWidth() - bitmap.getWidth() / 2 + mCircleRadius, getHeight() - getHeight() / 2
						+ mCircleRadius);
	...
	protected void onDraw(Canvas canvas) {
		...
		int sc = canvas.saveLayer(mRectF, null, Canvas.MATRIX_SAVE_FLAG | Canvas.CLIP_SAVE_FLAG
